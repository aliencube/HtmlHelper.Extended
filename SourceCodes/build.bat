...
::BUILD
"tools\nuget.exe" restore HtmlHelper.Extended.sln
"%MSBUILDDIR%msbuild.exe" "03_Services\HtmlHelperExtended\HtmlHelperExtended.csproj" /t:ReBuild /p:Configuration=Release;TargetFrameworkVersion=v4.5;DefineConstants="TRACE;NET45";OutPutPath=bin\Release\net45\;DocumentationFile=bin\Release\net45\Aliencube.HtmlHelper.Extended.xml
...
::PACK
"tools\nuget.exe" pack "03_Services\HtmlHelperExtended\HtmlHelperExtended.nuspec" -OutputDirectory build
